...
namespace PhysicManagement.Model
{
    ...
    public partial class PhysicManagementEntities : DbContext
    {
        ...
        public virtual DbSet<DoctorAlarm> DoctorAlarm { get; set; }
        public virtual DbSet<PhysicUserAlarm> PhysicUserAlarm { get; set; }
        public virtual DbSet<ResidentAlarm> ResidentAlarm { get; set; }
    }
}
